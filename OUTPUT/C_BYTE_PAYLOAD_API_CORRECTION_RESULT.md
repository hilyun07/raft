...
| `c/src/raft_internal.h` | Successive wrapper, pointer, type-separation, Ready/Advance, progress-snapshot naming, leadership-transfer cleanup, and Phase 4 boundary-helper corrections reached marker 9; Phase 6 private log ownership advances the current marker to 10. |
