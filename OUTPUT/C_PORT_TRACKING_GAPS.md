...
| Storage callback result ownership/batching | Exported Go callbacks cannot return Go Entry/Snapshot memory for C retention, and Entries must not callback once per entry. | Owned callback ABI Phase 2; batched deep-copy bridge and C call-through tests completed in Phase 5; real C log/core consumption and end-to-end tests remain in later core phases/Phase 12. | Callback ABI, Go bridge, C ownership/free code, tests, docs. |
